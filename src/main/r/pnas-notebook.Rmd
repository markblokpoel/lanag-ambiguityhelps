...
# special tag prefix for output files
tag = "uniform2000_"
...
### Analysis 1: Population distribution


### Analysis 2: Main results
This section describes how Fig. 2 in the paper is generated. This analysis consists of three parts: additional preprocessing and analysis, communicative success and delta asymmetry. The full panel in Fig 2. is generated at the end of this notebook under [Export to PDF](#pdf), which stiches all the subpanels together.
